---
title: "Accelerate your documentation workflow: Generate docs for whole folders at once | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/generating-dynamic-docs-dbt"
...
[![Meme of writing documentation](https://docs.getdbt.com/img/blog/2023-05-04-generating-dynamic-docs/1.png?v=2 "Meme of writing documentation")](#)Meme of writing documentation
...
[![dbt Docs UI](https://docs.getdbt.com/img/blog/2023-05-04-generating-dynamic-docs/2.jpg?v=2 "dbt Docs UI")](#)dbt Docs UI
...
[![Replace content in your markdown file](https://docs.getdbt.com/img/blog/2023-05-04-generating-dynamic-docs/3.png?v=2 "Replace content in your markdown file")](#)Replace content in your markdown file
...
[![Replace descriptions with dynamic doc blocks](https://docs.getdbt.com/img/blog/2023-05-04-generating-dynamic-docs/4.png?v=2 "Replace descriptions with dynamic doc blocks")](#)Replace descriptions with dynamic doc blocks
...
[![dbt Docs UI showing successful documentation leveraging docs blocks](https://docs.getdbt.com/img/blog/2023-05-04-generating-dynamic-docs/5.jpg?v=2 "dbt Docs UI showing successful documentation leveraging docs blocks")](#)dbt Docs UI showing successful documentation leveraging docs blocks
...
Building a historical user segmentation model with dbt](https://docs.getdbt.com/blog/historical-user-segmentation)[Older post

Modeling ragged time-varying hierarchies](https://docs.getdbt.com/blog/modeling-ragged-time-varying-hierarchies)
