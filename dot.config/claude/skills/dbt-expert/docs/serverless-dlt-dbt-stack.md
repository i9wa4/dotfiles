---
title: "Serverless, free-tier data stack with dlt + dbt core. | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/serverless-dlt-dbt-stack"
...
## The starting point[​](#the-starting-point "Direct link to The starting point")
...
## Towards a solution[​](#towards-a-solution "Direct link to Towards a solution")
...
[![Project architecture](https://docs.getdbt.com/img/blog/serverless-free-tier-data-stack-with-dlt-and-dbt-core/architecture_diagram.png?v=2 "Project architecture")](#)Project architecture

### Ingesting the data[​](#ingesting-the-data "Direct link to Ingesting the data")
...
### Transforming the data[​](#transforming-the-data "Direct link to Transforming the data")
...
### Production-readying the pipeline[​](#production-readying-the-pipeline "Direct link to Production-readying the pipeline")
...
## The outcome[​](#the-outcome "Direct link to The outcome")
...
[![Dashboard mapping overview](https://docs.getdbt.com/img/blog/serverless-free-tier-data-stack-with-dlt-and-dbt-core/map_screenshot.png?v=2 "Dashboard mapping overview")](#)Dashboard mapping overview
...
## Learnings and conclusion[​](#learnings-and-conclusion "Direct link to Learnings and conclusion")
...
### To sum up[​](#to-sum-up "Direct link to To sum up")
...
Column-Level Lineage, Model Performance, and Recommendations: ship trusted data products with dbt Explorer](https://docs.getdbt.com/blog/dbt-explorer)[Older post
