---
title: "Making dbt Cloud API calls using dbt-cloud-cli | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/making-dbt-cloud-api-calls-using-dbt-cloud-cli"
...
## What is dbt-cloud-cli and why should you use it?[​](#what-is-dbt-cloud-cli-and-why-should-you-use-it "Direct link to What is dbt-cloud-cli and why should you use it?")
...
* cURL triggered job run* dbt-cloud-cli triggered job run
...
## How the project came to be[​](#how-the-project-came-to-be "Direct link to How the project came to be")
...
## Creating a data catalog app using dbt Cloud artifacts[​](#creating-a-data-catalog-app-using-dbt-cloud-artifacts "Direct link to Creating a data catalog app using dbt Cloud artifacts")
...
Slim CI/CD with Bitbucket Pipelines for dbt Core](https://docs.getdbt.com/blog/slim-ci-cd-with-bitbucket-pipelines)[Older post

From the Slack Archives: When Backend Devs Spark Joy for Data Folks](https://docs.getdbt.com/blog/when-backend-devs-spark-joy)
