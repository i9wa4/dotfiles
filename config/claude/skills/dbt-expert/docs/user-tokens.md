---
title: "User tokens | dbt Developer Hub"
source_url: "https://docs.getdbt.com/docs/dbt-cloud-apis/user-tokens"
fetched_at: "2025-12-16T14:20:18.809572+00:00"
---



* * [API Access](https://docs.getdbt.com/docs/dbt-cloud-apis/authentication)* Personal access tokens
...
Ask questions about this page](https://chatgpt.com/?hints=search&prompt=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fdocs%2Fdbt-cloud-apis%2Fuser-tokens+so+I+can+ask+questions+about+it.)[Open in Claude

Ask questions about this page](https://claude.ai/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fdocs%2Fdbt-cloud-apis%2Fuser-tokens+so+I+can+ask+questions+about+it.)[Open in Perplexity

Ask questions about this page](https://www.perplexity.ai/search/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fdocs%2Fdbt-cloud-apis%2Fuser-tokens+so+I+can+ask+questions+about+it.)
...
* You must create and use unique tokens in each one of your dbt accounts that share the same email address.
  + For example, if [paul.atreides@example.com](mailto:paul.atreides@example.com) belongs to two dbt accounts: Spice Harvesting Account and Guild Navigator Account. Before this release, the same API key was used to access both of these accounts.
...
Authentication tokens](https://docs.getdbt.com/docs/dbt-cloud-apis/authentication)[Next

Service account tokens](https://docs.getdbt.com/docs/dbt-cloud-apis/service-tokens)

* [Create a personal access token](#create-a-personal-access-token)* [Delete a personal access token](#delete-a-personal-access-token)* [Migrate deprecated user API keys to personal access tokens](#migrate-deprecated-user-api-keys-to-personal-access-tokens)
      + [Using the personal access tokens](#using-the-personal-access-tokens)

[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/docs/dbt-cloud-apis/user-tokens.md)
