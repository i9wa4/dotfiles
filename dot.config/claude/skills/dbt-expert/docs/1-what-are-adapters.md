---
title: "Build, test, document, and promote adapters | dbt Developer Hub"
source_url: "https://docs.getdbt.com/guides/dbt-ecosystem/adapter-development/1-what-are-adapters"
...
Ask questions about this page](https://chatgpt.com/?hints=search&prompt=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Fadapter-creation+so+I+can+ask+questions+about+it.)[Open in Claude

Ask questions about this page](https://claude.ai/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Fadapter-creation+so+I+can+ask+questions+about+it.)[Open in Perplexity

Ask questions about this page](https://www.perplexity.ai/search/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Fadapter-creation+so+I+can+ask+questions+about+it.)
...
|  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Category Area of differences Examples|  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | Credentials & authentication Authentication - Username & password - MFA with `boto3` or Okta token | Connection opening/closing Create a new connection to db - `psycopg2.connect(connection_string)` - `google.cloud.bigquery.Client(...)` | Inserting local data Load seed .`csv` files into Python memory - `google.cloud.bigquery.Client.load_table_from_file(...)` (BigQuery) - `INSERT ... INTO VALUES ...` prepared statement (most other databases) | | | | | | | | | | | |
...
|  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Components Code Path Function|  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | Python classes `adapters/<adapter_name>` Configuration (Refer to [Python classes](#python classes)|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | Macros `include/<adapter_name>/macros/adapters/` SQL API & statement syntax (for example, how to create schema or how to get table info)|  |  |  | | --- | --- | --- | | Materializations `include/<adapter_name>/macros/materializations/` Table/view/snapshot/ workflow definitions | | | | | | | | | | | |
...
[![Diagram of adapter architecture](https://docs.getdbt.com/img/adapter-guide/adapter-architecture-diagram.png?v=2 "Diagram of adapter architecture")](#)Diagram of adapter architecture
...
The credentials class defines all of the database-specific credentials (e.g. `username` and `password`) that users will need in the [connection profile](https://docs.getdbt.com/docs/supported-data-platforms) for your new adapter. Each credentials contract should subclass dbt.adapters.base.Credentials, and be implemented as a python dataclass.
...
* Create a `profile_template.yml` to enable configuration prompts for a brand-new user setting up a connection profile via the [`dbt init` command](https://docs.getdbt.com/reference/commands/init). You will find more details in the following steps.
...
* [`adapter.dispatch` docs](https://docs.getdbt.com/reference/dbt-jinja-functions/dispatch)
...
* Adding to the list of ["Supported Data Platforms"](https://docs.getdbt.com/docs/supported-data-platforms#community-supported) (more info below)
...
* Existing users of your technology who are new to dbt
  ...
  + Provide a general overview of the value dbt will deliver to your users. This can lean on dbt's messaging and talking points which are laid out in the [dbt viewpoint.](https://docs.getdbt.com/community/resources/viewpoint)
...
![Full Release Post](https://docs.getdbt.com/assets/images/0-full-release-notes-1cc8cb263cb178df48deda1f69875c99.png)

Breaking this down:

* Visually distinctive announcement - make it clear this is a release

  [![title](https://docs.getdbt.com/img/adapter-guide/1-announcement.png?v=2 "title")](#)title
* Short written description of what is in the release

  [![description](https://docs.getdbt.com/img/adapter-guide/2-short-description.png?v=2 "description")](#)description
* Links to additional resources

  [![more resources](https://docs.getdbt.com/img/adapter-guide/3-additional-resources.png?v=2 "more resources")](#)more resources
* Implementation instructions:

  [![more installation](https://docs.getdbt.com/img/adapter-guide/4-installation.png?v=2 "more installation")](#)more installation
* Contributor recognition (if applicable)

  [![thank yous](https://docs.getdbt.com/img/adapter-guide/6-thank-contribs.png?v=2 "thank yous")](#)thank yous
