---
title: "The Spiritual Alignment of dbt + Airflow | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/dbt-airflow-spiritual-alignment"
...
![airflow and dbt skills required](https://docs.getdbt.com/assets/images/airflow-dbt-skills-622adbc9341238bf6b4ab586695cc5c0.png "airflow and dbt skills required")

The common skills needed for implementing any flavor of dbt (Core or Cloud) are:

* SQL: ‘nuff said
* YAML: required to generate config files for [writing tests on data models](https://docs.getdbt.com/docs/build/data-tests)
* [Jinja](https://docs.getdbt.com/guides/using-jinja): allows you to write DRY code (using [macros](https://docs.getdbt.com/docs/build/jinja-macros), for loops, if statements, etc)
...
> This is the same sensibility expressed in the [dbt viewpoint](https://docs.getdbt.com/community/resources/viewpoint) in 2016, the closest thing to a founding blog post as exists for dbt. ]
...
If your team’s dbt users are analysts rather than engineers, they still may need to be able to dig into the root cause of a failing dbt [source freshness test](https://docs.getdbt.com/docs/build/sources).
...
![airflow dashboard](https://docs.getdbt.com/assets/images/airflow-dbt-dashboard-2889f1ac1d5d04d57fbef4862aae5ac3.png "airflow dashboard")
...
dbt provides common programmatic interfaces (the [dbt Cloud Admin + Metadata APIs](https://docs.getdbt.com/docs/dbt-cloud-apis/overview), and [.json-based artifacts](https://docs.getdbt.com/reference/artifacts/dbt-artifacts) in the case of dbt Core) that provide the context needed for the engineer to self-serve—either by rerunning from a point of failure or reaching out to the owner.
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Dependency management Overhead Flexibility Infrastructure Overhead|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | dbt Core CLI + BashOperator Medium Low Medium Low|  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | Kubernetes Pod Operator Very Easy Medium High Medium|  |  |  |  |  | | --- | --- | --- | --- | --- | | | | | | | | | | | | | | | | | | | | | |
...
![airflow dbt run select](https://docs.getdbt.com/assets/images/airflow-dbt-run-select-c09ba717a1ee7e89a77beba393f0f339.png)
...
![airflow dbt run select](https://docs.getdbt.com/assets/images/dbt-airflow-tree-graph-f01aaf2666724d24c8261e71cff2af69.png)
...
Welcome to the dbt Developer Blog](https://docs.getdbt.com/blog/welcome)[Older post

How I Study Open Source Community Growth with dbt](https://docs.getdbt.com/blog/open-source-community-growth-analysis)
