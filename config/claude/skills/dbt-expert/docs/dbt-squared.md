---
title: "dbt Squared: Leveraging dbt Core and dbt Cloud together at scale | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/dbt-squared"
...
## The scalability problem[​](#the-scalability-problem "Direct link to The scalability problem")
...
[![Roche project structure as seen in the repository](https://docs.getdbt.com/img/blog/2023-04-17-dbt-squared/roche-project-tree.png?v=2 "Roche project structure as seen in the repository")](#)Roche project structure as seen in the repository
...
[![Roche project structure as seen in the repository](https://docs.getdbt.com/img/blog/2023-04-17-dbt-squared/roche-db-diagram.png?v=2 "Roche project structure as seen in the repository")](#)Roche project structure as seen in the repository
...
[![Roche project structure as seen in the repository](https://docs.getdbt.com/img/blog/2023-04-17-dbt-squared/roche-meme.png?v=2 "Roche project structure as seen in the repository")](#)Roche project structure as seen in the repository

## The solution: dbt Squared[​](#the-solution-dbt-squared "Direct link to The solution: dbt Squared")

### Technology and people[​](#technology-and-people "Direct link to Technology and people")
...
### Process[​](#process-1 "Direct link to Process")
...
### Project setup flow[​](#project-setup-flow "Direct link to Project setup flow")
...
### Development flow[​](#development-flow "Direct link to Development flow")
...
### Release flow[​](#release-flow "Direct link to Release flow")
...
Building a Kimball dimensional model with dbt](https://docs.getdbt.com/blog/kimball-dimensional-model)[Older post
