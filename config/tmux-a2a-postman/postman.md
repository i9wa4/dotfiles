...
### 3.7. Fallback: Orchestrator Absent
...
#### 4.4.1. Mode A: orchestrator -> guardian
...
#### 4.4.2. Mode B: guardian -> orchestrator
...
### 6.6. Blocker Detection Protocol
...
### 6.10. Fallback: Orchestrator Absent
...
### 7.14. Session Startup Checklist
