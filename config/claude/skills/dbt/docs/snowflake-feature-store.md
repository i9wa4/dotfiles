---
title: "Snowflake feature store and dbt: A bridge between data pipelines and ML | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/snowflake-feature-store"
...
## What is a feature?[​](#what-is-a-feature "Direct link to What is a feature?")
...
## What role does dbt play in getting data ready for ML models?[​](#what-role-does-dbt-play-in-getting-data-ready-for-ml-models "Direct link to What role does dbt play in getting data ready for ML models?")
...
## Who is going to use this and what benefits will they see?[​](#who-is-going-to-use-this-and-what-benefits-will-they-see "Direct link to Who is going to use this and what benefits will they see?")
...
## Why did we integrate/build this with Snowflake?[​](#why-did-we-integratebuild-this-with-snowflake "Direct link to Why did we integrate/build this with Snowflake?")
...
## Making it easier for ML/Data Engineers to both build & deploy ML data & models[​](#making-it-easier-for-mldata-engineers-to-both-build--deploy-ml-data--models "Direct link to Making it easier for ML/Data Engineers to both build & deploy ML data & models")
...
Finally, dbt Cloud also provides [dbt Explorer](https://docs.getdbt.com/docs/explore/explore-projects) — a perfect tool to catalog and share knowledge about organizational data across disparate teams. dbt Explorer provides a central place for information on data pipelines, including lineage information, data freshness, and quality. Best of all, dbt Explorer updates every time dbt jobs run, ensuring this information is always up-to-date and relevant.

## What tech is at play?[​](#what-tech-is-at-play "Direct link to What tech is at play?")
...
## Snowflake ML overview[​](#snowflake-ml-overview "Direct link to Snowflake ML overview")
...
## What do you need to do to make it all work?[​](#what-do-you-need-to-do-to-make-it-all-work "Direct link to What do you need to do to make it all work?")
...
## How to power ML pipelines with dbt and Snowflake’s Feature Store[​](#how-to-power-ml-pipelines-with-dbt-and-snowflakes-feature-store "Direct link to How to power ML pipelines with dbt and Snowflake’s Feature Store")
...
### Create feature tables as dbt models[​](#create-feature-tables-as-dbt-models "Direct link to Create feature tables as dbt models")
...
### Create or connect to a Snowflake Feature Store[​](#create-or-connect-to-a-snowflake-feature-store "Direct link to Create or connect to a Snowflake Feature Store")
...
### Create and register feature entities[​](#create-and-register-feature-entities "Direct link to Create and register feature entities")
...
### Register feature tables as feature views[​](#register-feature-tables-as-feature-views "Direct link to Register feature tables as feature views")
...
### Search and discover features in the Snowflake UI[​](#search-and-discover-features-in-the-snowflake-ui "Direct link to Search and discover features in the Snowflake UI")
...
[![Example of Snowflake UI](https://docs.getdbt.com/img/blog/example-snowflake-ui.png?v=2 "Example of Snowflake UI")](#)Example of Snowflake UI

### Generate training dataset[​](#generate-training-dataset "Direct link to Generate training dataset")
...
[![Example of training dataset](https://docs.getdbt.com/img/blog/example-training-data-set.png?v=2 "Example of training dataset")](#)Example of training dataset

### Train and deploy a model[​](#train-and-deploy-a-model "Direct link to Train and deploy a model")
...
[![Example of training data set](https://docs.getdbt.com/img/blog/example-features-produced.png?v=2 "Example of training data set")](#)Example of training data set
...
Test smarter not harder: add the right tests to your dbt project](https://docs.getdbt.com/blog/test-smarter-not-harder)[Older post

Iceberg Is An Implementation Detail](https://docs.getdbt.com/blog/icebeg-is-an-implementation-detail)
