...
required_groups='agent-harness-engineering agent-skills-management github create-review-comment subagent-review plan-design systematic-debugging data-platform diagramming programming'
