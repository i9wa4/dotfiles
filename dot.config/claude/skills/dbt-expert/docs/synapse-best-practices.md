---
title: "Up and Running with Azure Synapse on dbt Cloud | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/synapse-best-practices"
...
## Fabric Best Practices[​](#fabric-best-practices "Direct link to Fabric Best Practices")
...
## Fabric is the future[​](#fabric-is-the-future "Direct link to Fabric is the future")
...
## Resource Provisioning[​](#resource-provisioning "Direct link to Resource Provisioning")
...
### minimize pools; maximize DWUs[​](#minimize-pools-maximize-dwus "Direct link to minimize pools; maximize DWUs")
...
#### number of pools[​](#number-of-pools "Direct link to number of pools")
...
### Deployment Resources[​](#deployment-resources "Direct link to Deployment Resources")
...
#### permissions for analytics engineers[​](#permissions-for-analytics-engineers "Direct link to permissions for analytics engineers")
...
#### service principal permissions[​](#service-principal-permissions "Direct link to service principal permissions")
...
## Model Considerations[​](#model-considerations "Direct link to Model Considerations")
...
### distributions & indices[​](#distributions--indices "Direct link to distributions & indices")
...
## Deployments & Ecosystem[​](#deployments--ecosystem "Direct link to Deployments & Ecosystem")
...
### Upstream[​](#upstream "Direct link to Upstream")
...
### Downstream Consumers (Power BI)[​](#downstream-consumers-power-bi "Direct link to Downstream Consumers (Power BI)")
...
Putting Your DAG on the internet](https://docs.getdbt.com/blog/dag-on-the-internet)[Older post

Unit testing in dbt for test-driven development](https://docs.getdbt.com/blog/announcing-unit-testing)
