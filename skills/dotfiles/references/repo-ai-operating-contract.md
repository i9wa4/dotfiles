...
- `skills/dev-platform-workflow/SKILL.md` and
  `skills/dev-platform-workflow/references/github-workflow.md` own GitHub
  mechanics, issue/PR operations, inline comment mechanics,
