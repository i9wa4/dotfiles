...
| root AGENTS.md (local-invocation fallback only)    | `shared/local-fallback.md`                         | `codex/default.nix`                  |
...
The installed root Codex `AGENTS.md` (`shared/local-fallback.md`) is
