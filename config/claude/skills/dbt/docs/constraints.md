---
title: "constraints | dbt Developer Hub"
...
* * [Resource configs and properties](https://docs.getdbt.com/reference/resource-configs/resource-path)* [General properties](https://docs.getdbt.com/category/general-properties)* constraints
...
Ask questions about this page](https://chatgpt.com/?hints=search&prompt=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Freference%2Fresource-properties%2Fconstraints+so+I+can+ask+questions+about+it.)[Open in Claude

Ask questions about this page](https://claude.ai/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Freference%2Fresource-properties%2Fconstraints+so+I+can+ask+questions+about+it.)[Open in Perplexity

Ask questions about this page](https://www.perplexity.ai/search/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Freference%2Fresource-properties%2Fconstraints+so+I+can+ask+questions+about+it.)
...
Constraints require the declaration and enforcement of a model [contract](https://docs.getdbt.com/reference/resource-configs/contract).
...
config](https://docs.getdbt.com/reference/resource-properties/config)[Next

deprecation\_date](https://docs.getdbt.com/reference/resource-properties/deprecation_date)

* [Defining constraints](#defining-constraints)* [Platform-specific support](#platform-specific-support)
    + [Column-level constraint on nested column:](#column-level-constraint-on-nested-column)+ [Expected DDL to enforce constraints:](#expected-ddl-to-enforce-constraints)* [Custom constraints](#custom-constraints)
