---
title: "Data Vault 2.0 with dbt Cloud | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/data-vault-with-dbt-cloud"
...
[![Artist depiction of Data Vault reservoir and dam analogy courtesy of Gwen Windflower and Midjourney](https://docs.getdbt.com/img/blog/2023-07-03-data-vault-2-0-with-dbt-cloud/reservoir-dam-hallucination.png?v=2 "Artist depiction of Data Vault reservoir and dam analogy courtesy of Gwen Windflower and Midjourney")](#)Artist depiction of Data Vault reservoir and dam analogy courtesy of Gwen Windflower and Midjourney

## Data Vault components[​](#data-vault-components "Direct link to Data Vault components")
...
### Should you consider Data Vault for your data warehouse?[​](#should-you-consider-data-vault-for-your-data-warehouse "Direct link to Should you consider Data Vault for your data warehouse?")
...
## dbt Cloud: the operating system for Data Vault[​](#dbt-cloud-the-operating-system-for-data-vault "Direct link to dbt Cloud: the operating system for Data Vault")
...
### Scalable schema[​](#scalable-schema "Direct link to Scalable schema")
...
### Agile development[​](#agile-development "Direct link to Agile development")
...
### Auditable data[​](#auditable-data "Direct link to Auditable data")
...
Last but not least, the built-in [**dbt testing framework**](https://docs.getdbt.com/guides/dbt-ecosystem/dbt-python-snowpark/13-testing) allows Data Vault developers to test their assumptions about the data in their database. Not only are primary key checks and foreign key checks easy to add and simple to run, but more complex checks like integer range checks, anomaly detection, and highly sophisticated data quality checks are also possible expressed as SQL statements. Infinite Lambda have created two dbt packages for data quality, [dq\_tools](https://hub.getdbt.com/infinitelambda/dq_tools/latest/) and [dq\_vault](https://hub.getdbt.com/infinitelambda/dq_vault/latest/), which are described later in this post.

## How to get started with dbt Cloud and Data Vault[​](#how-to-get-started-with-dbt-cloud-and-data-vault "Direct link to How to get started with dbt Cloud and Data Vault")
...
### Customizing the existing packages[​](#customizing-the-existing-packages "Direct link to Customizing the existing packages")
...
Within the [dq\_tools](https://hub.getdbt.com/infinitelambda/dq_tools/latest/) \_package, we aim for simple storing test results and visualization of these in a BI dashboard. Leveraging this tool can help with making sure your system behaves in an expected way, all in a visual format of dashboard built on your favorite BI tool. [dq\_vault](https://hub.getdbt.com/infinitelambda/dq_vault/latest/) package provides an overview of data quality for all Data Vault models in your dbt project. Complex as it is, Data Vault projects need detailed test coverage to make sure there are no holes in the system. This tool helps with governing your testing strategy and being able to identify issues very quickly.
...
[![Friends don't let friends make a data dungeon](https://docs.getdbt.com/img/blog/2023-07-03-data-vault-2-0-with-dbt-cloud/data-dungeon-meme.jpeg?v=2 "Friends don't let friends make a data dungeon")](#)Friends don't let friends make a data dungeon

### Entity Relation Diagrams (ERDs) and dbt[​](#entity-relation-diagrams-erds-and-dbt "Direct link to Entity Relation Diagrams (ERDs) and dbt")
...
Create dbt Documentation and Tests 10x faster with ChatGPT](https://docs.getdbt.com/blog/create-dbt-documentation-10x-faster-with-ChatGPT)[Older post

Building a historical user segmentation model with dbt](https://docs.getdbt.com/blog/historical-user-segmentation)
