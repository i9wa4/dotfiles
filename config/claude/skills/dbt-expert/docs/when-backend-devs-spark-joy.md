---
title: "From the Slack Archives: When Backend Devs Spark Joy for Data Folks | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/when-backend-devs-spark-joy"
...
![A screenshot of the conversation that started the thread](https://docs.getdbt.com/assets/images/slack_thread_screenshot-95eaf226223ed4ef6fb530c6cf04d756.png)
*A screenshot of the conversation that started the thread*

## When the pieces fall into place[​](#when-the-pieces-fall-into-place "Direct link to When the pieces fall into place")
...
### Signs the data is sparking joy[​](#signs-the-data-is-sparking-joy "Direct link to Signs the data is sparking joy")
...
### Signs that operations are sparking joy[​](#signs-that-operations-are-sparking-joy "Direct link to Signs that operations are sparking joy")
...
Making dbt Cloud API calls using dbt-cloud-cli](https://docs.getdbt.com/blog/making-dbt-cloud-api-calls-using-dbt-cloud-cli)[Older post
