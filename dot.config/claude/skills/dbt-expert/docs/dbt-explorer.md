---
title: "Column-Level Lineage, Model Performance, and Recommendations: ship trusted data products with dbt Explorer | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/dbt-explorer"
...
[![Look at that lineage!](https://docs.getdbt.com/img/blog/2024-02-13-dbt-explorer/full-lineage.png?v=2 "Look at that lineage!")](#)Look at that lineage!
...
[![You can trace the data in a column from the source to the end of your DAG!](https://docs.getdbt.com/img/blog/2024-02-13-dbt-explorer/column-level-lineage.png?v=2 "You can trace the data in a column from the source to the end of your DAG!")](#)You can trace the data in a column from the source to the end of your DAG!
...
[![passing model! passing tests!](https://docs.getdbt.com/img/blog/2024-02-13-dbt-explorer/embedded-metadata-model.png?v=2 "passing model! passing tests!")](#)passing model! passing tests!

[![have you ever seen a fresher source?](https://docs.getdbt.com/img/blog/2024-02-13-dbt-explorer/embedded-metadata-source.png?v=2 "have you ever seen a fresher source?")](#)have you ever seen a fresher source?
...
[![The recommendations summary — I’ve got some work to do!](https://docs.getdbt.com/img/blog/2024-02-13-dbt-explorer/recommendations.png?v=2 "The recommendations summary — I’ve got some work to do!")](#)The recommendations summary — I’ve got some work to do!
...
[![maybe I should check on that one long run!](https://docs.getdbt.com/img/blog/2024-02-13-dbt-explorer/model-execution.png?v=2 "maybe I should check on that one long run!")](#)maybe I should check on that one long run!
...
LLM-powered Analytics Engineering: How we're using AI inside of our dbt project, today, with no new tools.](https://docs.getdbt.com/blog/dbt-models-with-snowflake-cortex)[Older post

Serverless, free-tier data stack with dlt + dbt core.](https://docs.getdbt.com/blog/serverless-dlt-dbt-stack)
