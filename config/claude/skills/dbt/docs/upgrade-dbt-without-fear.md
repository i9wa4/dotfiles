---
title: "How to Upgrade dbt Versions (Mostly) Without Fear | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/upgrade-dbt-without-fear"
...
## Step 1: Decide which version you are upgrading to[​](#step-1-decide-which-version-you-are-upgrading-to "Direct link to Step 1: Decide which version you are upgrading to")
...
## Step 3: Upgrade dbt[​](#step-3-upgrade-dbt "Direct link to Step 3: Upgrade dbt")
...
## Step 4: Try to run `dbt compile`[​](#step-4-try-to-run-dbt-compile "Direct link to step-4-try-to-run-dbt-compile")
...
## Step 5: Handle any deprecations[​](#step-5-handle-any-deprecations "Direct link to Step 5: Handle any deprecations")
...
### Step 5a. Update your packages[​](#step-5a-update-your-packages "Direct link to Step 5a. Update your packages")
...
### Step 5c. Rinse and repeat[​](#step-5c-rinse-and-repeat "Direct link to Step 5c. Rinse and repeat")
...
## Step 6. Test and review[​](#step-6-test-and-review "Direct link to Step 6. Test and review")
...
## Step 7. Merge and communicate[​](#step-7-merge-and-communicate "Direct link to Step 7. Merge and communicate")
...
Generating Surrogate Keys Across Warehouses](https://docs.getdbt.com/blog/sql-surrogate-keys)[Older post
