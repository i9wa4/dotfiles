---
title: "How we built consistent product launch metrics with the dbt Semantic Layer | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/product-analytics-pipeline-with-dbt-semantic-layer"
...
## Getting your data ready for metrics[​](#getting-your-data-ready-for-metrics "Direct link to Getting your data ready for metrics")
...
[![Semantic Layer DAG in dbt Explorer](https://docs.getdbt.com/img/blog/2023-12-11-semantic-layer-on-semantic-layer/Screenshot-dag.png?v=2 "Semantic Layer DAG in dbt Explorer")](#)Semantic Layer DAG in dbt Explorer
...
## [How we build semantic models and metrics](https://docs.getdbt.com/best-practices/how-we-build-our-metrics/semantic-layer-1-intro)[​](#how-we-build-semantic-models-and-metrics "Direct link to how-we-build-semantic-models-and-metrics")
...
[![Semantic Layer DAG in dbt Explorer](https://docs.getdbt.com/img/blog/2023-12-11-semantic-layer-on-semantic-layer/Screenshot-metrics-dag.png?v=2 "Semantic Layer DAG in dbt Explorer")](#)Semantic Layer DAG in dbt Explorer
...
## Our Finance, Operations and GTM teams are all looking at the same metrics 😊[​](#our-finance-operations-and-gtm-teams-are-all-looking-at-the-same-metrics- "Direct link to Our Finance, Operations and GTM teams are all looking at the same metrics 😊")
...
[![Semantic Layer query builder in Hex](https://docs.getdbt.com/img/blog/2023-12-11-semantic-layer-on-semantic-layer/Screenshot-hex.png?v=2 "Semantic Layer query builder in Hex")](#)Semantic Layer query builder in Hex
...
[![Semantic Layer query builder in Google Sheets](https://docs.getdbt.com/img/blog/2023-12-11-semantic-layer-on-semantic-layer/Screenshot-gsheets.png?v=2 "Semantic Layer query builder in Google Sheets")](#)Semantic Layer query builder in Google Sheets
...
## The Result: Consistent Governed Metrics[​](#the-result-consistent-governed-metrics "Direct link to The Result: Consistent Governed Metrics")
...
How to integrate with dbt](https://docs.getdbt.com/blog/integrating-with-dbtcloud)[Older post

Why you should specify a production environment in dbt Cloud](https://docs.getdbt.com/blog/specify-prod-environment)
