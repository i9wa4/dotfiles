...
#                               does not rewrite nix/lib/claude-code-pin.nix or nix/lib/codex-pin.nix
...
#   edit nix/lib/codex-pin.nix
#                             -- pin Codex version and fetch hashes in one place
