---
title: "The Exact GitHub Pull Request Template We Use at dbt Labs | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/analytics-pull-request-template"
...
## The GitHub PR template we use[​](#the-github-pr-template-we-use "Direct link to The GitHub PR template we use")
...
### How and why this GitHub PR template works[​](#how-and-why-this-github-pr-template-works "Direct link to How and why this GitHub PR template works")
...
#### Description & motivation:[​](#description--motivation "Direct link to Description & motivation:")
...
![dbt dag check](https://docs.getdbt.com/assets/images/pr-template-dag-check-22f4763638e206355457e5addae34e77.png "dbt DAG check")
...
#### Changes to existing models:[​](#changes-to-existing-models "Direct link to Changes to existing models:")
...
Each PR should represent a cohesive body of work—a specific fct model, or staging a particular data source. If you’re having trouble narrowing down and describing ***the thing*** your PR does, it may be too broad.
...
![woof](https://docs.getdbt.com/assets/images/pr-template-woof-1c81f2a6b710360d23dbad64cab3cf34.gif "woof")
...
By default, all new models should have *at least* unique and not null tests on the primary key.
...
![choose your materializations wisely](https://docs.getdbt.com/assets/images/pr-template-fct-meme-82cd47ee1d3b193d1bfb8adb9d52da35.jpeg "choose your materializations wisely")
...
## Adding the full GitHub PR template to your repository[​](#adding-the-full-github-pr-template-to-your-repository "Direct link to Adding the full GitHub PR template to your repository")
...
### Create a markdown file[​](#create-a-markdown-file "Direct link to Create a markdown file")
...
### Add the `.md` file to your GitHub repository[​](#add-the-md-file-to-your-github-repository "Direct link to add-the-md-file-to-your-github-repository")
...
### And that’s it![​](#and-thats-it "Direct link to And that’s it!")
...
How to Build a Mature dbt Project from Scratch](https://docs.getdbt.com/blog/how-to-build-a-mature-dbt-project-from-scratch)[Older post

The Exact dbt Commands We Run in Production](https://docs.getdbt.com/blog/dbt-production-commands)
