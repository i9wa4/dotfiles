---
title: "COALESCE SQL function: Why we love it | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/coalesce-sql-love-letter"
...
## How to use the COALESCE function[​](#how-to-use-the-coalesce-function "Direct link to How to use the COALESCE function")
...
> **See it in action:**
> The COALESCE function is used in the [surrogate\_key](https://docs.getdbt.com/blog/sql-surrogate-keys) macro to replace null column values.

### Data warehouse support for the COALESCE function[​](#data-warehouse-support-for-the-coalesce-function "Direct link to Data warehouse support for the COALESCE function")
...
## COALESCE SQL function example[​](#coalesce-sql-function-example "Direct link to COALESCE SQL function example")

Let’s look at an actual example using COALESCE. Below, we have an `orders` table with three column values: an `order_id`, `order_date`, and `order_status`.

|  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **order\_id** **order\_date** **order\_status**|  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | 12389 2022-01-02 |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | 34553 2020-04-23 returned|  |  |  | | --- | --- | --- | | 78411 2022-06-06  | | | | | | | | | | | |
...
|  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **order\_id** **order\_date** **order\_status**|  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | 12389 2022-01-02 not\_returned|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | 34553 2020-04-23 returned|  |  |  | | --- | --- | --- | | 78411 2022-06-06 not\_returned | | | | | | | | | | | |
...
LOWER SQL function: Why we love it](https://docs.getdbt.com/blog/lower-sql-love-letter)[Older post

Slim CI/CD with Bitbucket Pipelines for dbt Core](https://docs.getdbt.com/blog/slim-ci-cd-with-bitbucket-pipelines)
