...
Automation and a reusable skill are future follow-ups. Promote this workflow
only after repeated use shows stable boundaries that are worth automating.
...
- Reusable prompt packaging as a skill.
