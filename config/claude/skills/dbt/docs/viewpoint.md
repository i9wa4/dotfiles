---
title: "The dbt Viewpoint | dbt Developer Hub"
...
* * Additional resources* The dbt Viewpoint
...
Ask questions about this page](https://chatgpt.com/?hints=search&prompt=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fcommunity%2Fresources%2Fviewpoint+so+I+can+ask+questions+about+it.)[Open in Claude

Ask questions about this page](https://claude.ai/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fcommunity%2Fresources%2Fviewpoint+so+I+can+ask+questions+about+it.)[Open in Perplexity

Ask questions about this page](https://www.perplexity.ai/search/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fcommunity%2Fresources%2Fviewpoint+so+I+can+ask+questions+about+it.)
...
Realtime event participation](https://docs.getdbt.com/community/contributing/contributing-realtime-events)[Next

Code of Conduct](https://docs.getdbt.com/community/resources/code-of-conduct)

* [Analytics today](#analytics-today)* [Analytics is collaborative](#analytics-is-collaborative)
    + [Version Control](#version-control)+ [Quality Assurance](#quality-assurance)+ [Documentation](#documentation)+ [Modularity](#modularity)* [Analytic code is an asset](#analytic-code-is-an-asset)
      + [Environments](#environments)+ [Service level guarantees](#service-level-guarantees)+ [Design for maintainability](#design-for-maintainability)* [Analytics workflows require automated tools](#analytics-workflows-require-automated-tools)

[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/community/resources/viewpoint.md)
