---
title: "Stronger together: Python, dataframes, and SQL | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/polyglot-dbt-python-dataframes-sql"
...
Snowpark DataFrames are only supported in Snowflake, while Spark DataFrames are only available on Databricks and BigQuery. It’s also worth keeping in mind that different types of dataframes use [different syntax](https://docs.getdbt.com/docs/build/python-models#dataframe-api-and-syntax).
...
Demystifying event streams: Transforming events into tables with dbt](https://docs.getdbt.com/blog/demystifying-event-streams)[Older post

Analysts make the best analytics engineers](https://docs.getdbt.com/blog/analysts-make-the-best-aes)
