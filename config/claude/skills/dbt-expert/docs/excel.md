---
title: "Microsoft Excel | dbt Developer Hub"
source_url: "https://docs.getdbt.com/docs/cloud-integrations/semantic-layer/excel"
fetched_at: "2025-12-16T14:20:18.809572+00:00"
---



* * [dbt integrations](https://docs.getdbt.com/docs/cloud-integrations/overview)* [Semantic Layer integrations](https://docs.getdbt.com/docs/cloud-integrations/avail-sl-integrations)* Microsoft Excel
...
Ask questions about this page](https://chatgpt.com/?hints=search&prompt=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fdocs%2Fcloud-integrations%2Fsemantic-layer%2Fexcel+so+I+can+ask+questions+about+it.)[Open in Claude

Ask questions about this page](https://claude.ai/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fdocs%2Fcloud-integrations%2Fsemantic-layer%2Fexcel+so+I+can+ask+questions+about+it.)[Open in Perplexity

Ask questions about this page](https://www.perplexity.ai/search/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fdocs%2Fcloud-integrations%2Fsemantic-layer%2Fexcel+so+I+can+ask+questions+about+it.)
...
Access [saved queries](https://docs.getdbt.com/docs/build/saved-queries), powered by MetricFlow, in Microsoft Excel to quickly get results from pre-defined sets of data. To access the saved queries in Microsoft Excel:

1. Open the hamburger menu in Microsoft Excel.- Navigate to **Saved Queries** to access the ones available to you.- You can also select **Build Selection**, which allows you to explore the existing query. This won't change the original query defined in the code.
...
Google Sheets](https://docs.getdbt.com/docs/cloud-integrations/semantic-layer/gsheets)[Next

Power BI](https://docs.getdbt.com/docs/cloud-integrations/semantic-layer/power-bi)
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/docs/cloud-integrations/semantic-layer/excel.md)
