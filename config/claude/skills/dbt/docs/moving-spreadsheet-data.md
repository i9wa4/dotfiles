---
title: "How to move data from spreadsheets into your data warehouse | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/moving-spreadsheet-data"
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Option/connector Data updatable after load Configurable data types Multiple tables per schema Good for large datasets|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | dbt seeds ✅ ✅ ✅ ❌|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | Fivetran Browser Upload ✅ ✅ ✅ ✅|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | Fivetran Google Sheets connector ✅ ❌ ❌ ✅|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | Fivetran Google Drive connector ❌ ❌ ✅ ✅|  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | Stitch Google Sheets integration ✅ ❌ ❌ ✅|  |  |  |  |  | | --- | --- | --- | --- | --- | | Airbyte Google Sheets connector ✅ ❌ ❌ ✅ | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | |
...
A nice benefit of the uploader is support for updating data in the table over time. If a file with the same name and same columns is uploaded, any new records will be added, and existing records (per the primary key) will be updated.
...
Introducing the dbt\_project\_evaluator: Automatically evaluate your dbt project for alignment with best practices](https://docs.getdbt.com/blog/align-with-dbt-project-evaluator)[Older post

A journey through the Foundry: Becoming an analytics engineer at dbt Labs](https://docs.getdbt.com/blog/wasila-foundry-experience)
