---
title: "Quickstart for dbt and Azure Synapse Analytics | dbt Developer Hub"
source_url: "https://docs.getdbt.com/guides/azure-synapse-analytics?step=1"
...
Ask questions about this page](https://chatgpt.com/?hints=search&prompt=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Fazure-synapse-analytics+so+I+can+ask+questions+about+it.)[Open in Claude

Ask questions about this page](https://claude.ai/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Fazure-synapse-analytics+so+I+can+ask+questions+about+it.)[Open in Perplexity

Ask questions about this page](https://www.perplexity.ai/search/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Fazure-synapse-analytics+so+I+can+ask+questions+about+it.)
...
5. Copy these statements into the SQL editor to load the Jaffle Shop example data:
   ...
   [![Example of loading data](https://docs.getdbt.com/img/quickstarts/dbt-cloud/example-load-data-azure-syn-analytics.png?v=2 "Example of loading data")](#)Example of loading data
