---
title: "Quickstart for dbt and Microsoft Fabric | dbt Developer Hub"
source_url: "https://docs.getdbt.com/guides/microsoft-fabric?step=1"
...
Ask questions about this page](https://chatgpt.com/?hints=search&prompt=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Fmicrosoft-fabric+so+I+can+ask+questions+about+it.)[Open in Claude

Ask questions about this page](https://claude.ai/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Fmicrosoft-fabric+so+I+can+ask+questions+about+it.)[Open in Perplexity

Ask questions about this page](https://www.perplexity.ai/search/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Fmicrosoft-fabric+so+I+can+ask+questions+about+it.)
...
* [About continuous integration jobs](https://docs.getdbt.com/docs/deploy/continuous-integration)
...
2. On the home page, select the **Synapse Data Warehouse** tile.
   ...
   [![Example of the Synapse Data Warehouse tile](https://docs.getdbt.com/img/quickstarts/dbt-cloud/example-start-fabric.png?v=2 "Example of the Synapse Data Warehouse tile")](#)Example of the Synapse Data Warehouse tile
...
6. Copy these statements into the SQL editor to load the Jaffle Shop example data:
   ...
   (
       [ID] [int],
       [FIRST_NAME] [varchar](https://docs.getdbt.com/guides/8000),
       [LAST_NAME] [varchar](https://docs.getdbt.com/guides/8000)
   );
   ...
   (
       ...
       -- [ORDER_DATE] [int],
       [ORDER_DATE] [date],
       [STATUS] [varchar](https://docs.getdbt.com/guides/8000)
   );
   ...
   (
       [ID] [int],
       [ORDERID] [int],
       [PAYMENTMETHOD] [varchar](https://docs.getdbt.com/guides/8000),
       [STATUS] [varchar](https://docs.getdbt.com/guides/8000),
       [AMOUNT] [int],
       [CREATED] [date]
   );
   ...
   [![Example of loading data](https://docs.getdbt.com/img/quickstarts/dbt-cloud/example-load-data-ms-fabric.png?v=2 "Example of loading data")](#)Example of loading data
