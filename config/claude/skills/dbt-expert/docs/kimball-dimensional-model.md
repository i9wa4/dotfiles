---
title: "Building a Kimball dimensional model with dbt | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/kimball-dimensional-model"
...
[![Raw 3NF data to dimensional model](https://docs.getdbt.com/img/blog/2023-04-18-building-a-kimball-dimensional-model-with-dbt/3nf-to-dimensional-model.png?v=2 "Raw 3NF data to dimensional model")](#)Raw 3NF data to dimensional model
...
[![Source schema](https://docs.getdbt.com/img/blog/2023-04-18-building-a-kimball-dimensional-model-with-dbt/source-schema.png?v=2 "Source schema")](#)Source schema
...
[![Conversation between business user and analytics engineer](https://docs.getdbt.com/img/blog/2023-04-18-building-a-kimball-dimensional-model-with-dbt/conversation.png?v=2 "Conversation between business user and analytics engineer")](#)Conversation between business user and analytics engineer
...
[![Sales Order Header and Detail](https://docs.getdbt.com/img/blog/2023-04-18-building-a-kimball-dimensional-model-with-dbt/sales-order-header-detail.png?v=2 "Sales Order Header and Detail")](#)Sales Order Header and Detail
...
[![fct_sales table](https://docs.getdbt.com/img/blog/2023-04-18-building-a-kimball-dimensional-model-with-dbt/fct_sales.png?v=2 "fct_sales table")](#)fct\_sales table
...
[![Snowflake schema](https://docs.getdbt.com/img/blog/2023-04-18-building-a-kimball-dimensional-model-with-dbt/snowflake-schema.png?v=2 "Snowflake schema")](#)Snowflake schema
...
[![Star schema](https://docs.getdbt.com/img/blog/2023-04-18-building-a-kimball-dimensional-model-with-dbt/star-schema.png?v=2 "Star schema")](#)Star schema
...
[![Dimension tables](https://docs.getdbt.com/img/blog/2023-04-18-building-a-kimball-dimensional-model-with-dbt/dimension-tables.png?v=2 "Dimension tables")](#)Dimension tables
...
[![Final dimensional model ERD](https://docs.getdbt.com/img/blog/2023-04-18-building-a-kimball-dimensional-model-with-dbt/target-schema.png?v=2 "Final dimensional model ERD")](#)Final dimensional model ERD
...
[![Final dbt DAG](https://docs.getdbt.com/img/blog/2023-04-18-building-a-kimball-dimensional-model-with-dbt/dbt-dag.png?v=2 "Final dbt DAG")](#)Final dbt DAG
...
How we reduced a 6-hour runtime in Alteryx to 9 minutes with dbt and Snowflake](https://docs.getdbt.com/blog/framework-refactor-alteryx-dbt)[Older post
