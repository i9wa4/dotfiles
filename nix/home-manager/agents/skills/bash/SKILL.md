---
name: bash
description: Bash scripting rules for subshell avoidance, brace grouping, pipe redirection, and HEREDOC usage in this repo's Bash tool calls. Use when writing shell commands or scripts.
---
