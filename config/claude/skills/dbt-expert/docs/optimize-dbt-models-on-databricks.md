---
title: "Optimize and troubleshoot dbt models on Databricks | dbt Developer Hub"
source_url: "https://docs.getdbt.com/guides/optimize-dbt-models-on-databricks"
...
Ask questions about this page](https://chatgpt.com/?hints=search&prompt=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Foptimize-dbt-models-on-databricks+so+I+can+ask+questions+about+it.)[Open in Claude

Ask questions about this page](https://claude.ai/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Foptimize-dbt-models-on-databricks+so+I+can+ask+questions+about+it.)[Open in Perplexity

Ask questions about this page](https://www.perplexity.ai/search/new?q=Read+from+https%3A%2F%2Fdocs.getdbt.com%2Fguides%2Foptimize-dbt-models-on-databricks+so+I+can+ask+questions+about+it.)
...
dbt has guidelines on how you can [structure your dbt project](https://docs.getdbt.com/best-practices/how-we-structure/1-guide-overview) which you can learn more about.
