---
title: "DATEDIFF SQL function: Why we love it | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/datediff-sql-love-letter/index"
...
### DATEDIFF in Snowflake, Amazon Redshift, and Databricks[​](#datediff-in-snowflake-amazon-redshift-and-databricks "Direct link to DATEDIFF in Snowflake, Amazon Redshift, and Databricks")
...
DATE\_TRUNC SQL function: Why we love it](https://docs.getdbt.com/blog/date-trunc-sql)[Older post
