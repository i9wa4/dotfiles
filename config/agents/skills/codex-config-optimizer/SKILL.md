...
- @~/ghq/github.com/i9wa4/dotfiles/nix/home-manager/codex-cli.nix
...
| `~/.codex/AGENTS.md`   | `config/agents/AGENTS.md`          | codex-cli.nix    |
| `~/.codex/rules/`      | `config/agents/rules/`             | codex-cli.nix    |
| `~/.codex/skills/`     | Multiple flake inputs + local      | agent-skills.nix |
| MCP servers            | `nix/home-manager/mcp-servers.nix` | codex-cli.nix    |
...
To update settings, edit `nix/home-manager/codex-cli.nix` and rebuild.
