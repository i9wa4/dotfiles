---
title: "Deprecation of dbt Server | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/deprecation-of-dbt-server"
...
## Why are we deprecating dbt Server?[​](#why-are-we-deprecating-dbt-server "Direct link to Why are we deprecating dbt Server?")
...
Serverless, free-tier data stack with dlt + dbt core.](https://docs.getdbt.com/blog/serverless-dlt-dbt-stack)[Older post
