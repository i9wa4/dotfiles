---
title: "A star (generator) is born | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/star-sql-love-letter"
...
dbt supports [dbt\_utils](https://github.com/dbt-labs/dbt-utils), a [package of macros and tests](https://docs.getdbt.com/docs/build/packages) that data folks can use to help them write more DRY code in their dbt project. One of the macros dbt utils offers is the `star` generator.
...
![](https://docs.getdbt.com/assets/images/utils-madness-1-afcc9d6de83a8f8f1e52ea2e6fa47ded.png)
...
Tackling the complexity of joining snapshots](https://docs.getdbt.com/blog/joining-snapshot-complexity)[Older post

Optimizing dbt Models with Redshift Configurations](https://docs.getdbt.com/blog/redshift-configurations-dbt-model-optimizations)
