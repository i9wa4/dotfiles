...
| (no `~/.codex/AGENTS.md`) | Persona / language / scope and inlined skill bodies are delivered through postman.md `[common_template]` (§2.16-§2.22 inline skills, §2.24 persona) on each `tmux-a2a-postman pop` | `config/tmux-a2a-postman/postman.md` |
