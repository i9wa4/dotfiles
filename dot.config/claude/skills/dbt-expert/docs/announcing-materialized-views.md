---
title: "Optimizing Materialized Views with dbt | dbt Developer Blog"
source_url: "https://docs.getdbt.com/blog/announcing-materialized-views"
...
* [dbt-postgres](https://docs.getdbt.com/reference/resource-configs/postgres-configs#materialized-views)
* [dbt-redshift](https://docs.getdbt.com/reference/resource-configs/redshift-configs#materialized-views)
* [dbt-snowflake](https://docs.getdbt.com/reference/resource-configs/snowflake-configs#dynamic-tables)
* [dbt-databricks](https://docs.getdbt.com/reference/resource-configs/databricks-configs#materialized-views-and-streaming-tables)
* [dbt-materialize\*](https://docs.getdbt.com/reference/resource-configs/materialize-configs#incremental-models-materialized-views)
* [dbt-trino\*](https://docs.getdbt.com/reference/resource-configs/trino-configs#materialized-view)
* [dbt-bigquery (available on 1.7)](https://docs.getdbt.com/reference/resource-configs/bigquery-configs#materialized-views)
...
[![A Real Time Pipeline](https://docs.getdbt.com/img/blog/2023-08-01-announcing-materialized-views/streaming-pipeline.png?v=2 "A Real Time Pipeline")](#)A Real Time Pipeline
...
To defer or to clone, that is the question](https://docs.getdbt.com/blog/to-defer-or-to-clone)[Older post

Create dbt Documentation and Tests 10x faster with ChatGPT](https://docs.getdbt.com/blog/create-dbt-documentation-10x-faster-with-ChatGPT)
